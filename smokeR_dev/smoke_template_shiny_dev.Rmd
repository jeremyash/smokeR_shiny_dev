...
The predicted weather data for this area, including fire behavior and smoke parameters can be found on the [Fire Weather Dashboard](`r fwd_url`). `r if(!(is.null(params$SUPERFOG_SCREEN_SELECT))){superfog_sen}`
